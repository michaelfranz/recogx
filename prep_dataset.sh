...
# Copy mfc images 5000-5999 for both males and females to validation folder
cp mfc_dataset/female_5???.jpg mfc_dataset_train_test/val/female
cp mfc_dataset/male_5???.jpg mfc_dataset_train_test/val/male
